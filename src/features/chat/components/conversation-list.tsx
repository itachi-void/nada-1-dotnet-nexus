...
export function ConversationList({
  ...
  return (
    <div className='border-border/40 bg-background hidden h-full flex-col gap-4 overflow-hidden rounded-2xl border p-3 lg:col-start-1 lg:col-end-2 lg:flex lg:rounded-3xl lg:p-4'>
